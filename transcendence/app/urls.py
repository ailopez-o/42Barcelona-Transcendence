...
urlpatterns = [
    ...
    path('game/new/monument_pixel/', views.new_game_monument_pixel_view, name='new_game_monument_pixel'),
    path('game/<int:game_id>/', views.game_detail_view, name='game_detail'),
    path('game/<int:game_id>/monument_pixel/', views.game_detail_monument_pixel_view, name='game_detail_monument_pixel'),
