# Generated by Django 5.1.4 on 2025-02-11 14:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_connected', models.ManyToManyField(related_name='remote_sessions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Tournament',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.game')),
